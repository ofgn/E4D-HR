...
module v_analytic
    ...
    subroutine calculate_mean_model()
        ...
        ! Sum the apparent conductivities and weights
        ! Update the minimum and maximum apparent conductivities
        open(newunit=j, file='app.txt', status='unknown')
        ...
        call export_model_dc(model_name="mean")
    ...
    subroutine calculate_median_model()
        ...
        call export_model_dc(model_name="median")
