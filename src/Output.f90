...
contains
   subroutine output_dpred
      ! This subroutine writes the predicted data to a file
      ! The file name is read from the output options file
      ! The file name is the second line in the output options file
      ! The first line in the output options file is the output flag
      implicit none
